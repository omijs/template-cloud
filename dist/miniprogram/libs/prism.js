...
var Prism = function (_self) {
  ...
  var _ = {
    ...
    tokens: function tokens(text, grammar, language) {
      var env = {
        code: text,
        grammar: grammar,
        language: language
    ...
    _walkContent: function _walkContent(arr) {
...
(function () {
  ...
  window.addEventListener('resize', function () {
    Array.prototype.forEach.call(document.querySelectorAll("pre.line-numbers"), _resizeElement);
  });
