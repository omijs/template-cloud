...
global.Omi.definePage('page-about', (_temp2 = _class = function (_WeElement) {
  ...
  function _TaroComponentClass() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _TaroComponentClass.__proto__ || Object.getPrototypeOf(_TaroComponentClass)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp"], _this.config = {
  ...
  _createClass(_TaroComponentClass, [{
    ...
    value: function _createData() {
      ...
      ;
      var anonymousState__temp = "/pages/about/omijs-org.png";
...
}(_index3.WeElement), _class.properties = {}, _class.$$events = [], _temp2), "pages/about/index");
global.create.Page(global.getOptions('pages/about/index'));